...
public class UpdateProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateProduct(id, name, image, inputDate, priceValue, quantityValue, description, categoryValue);
        request.setAttribute("messSuccess", "Bạn vừa cập nhật thành công!");
